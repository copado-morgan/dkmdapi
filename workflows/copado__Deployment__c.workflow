...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Custom_Deployment_Completed_email_alert</fullName>
        <ccEmails>dkellogg@copado.com</ccEmails>
        <description>Custom Deployment Completed email alert</description>
        <protected>false</protected>
        <recipients>
            <recipient>majimenez+dandemo@copado.com</recipient>
            <type>user</type>
        </recipients>
    ...
    <rules>
        <fullName>Custom Deployment Completed</fullName>
        <actions>
            <name>Custom_Deployment_Completed_email_alert</name>
            <type>Alert</type>
        </actions>
        <active>false</active>
        ...
        <criteriaItems>
            ...
            <operation>equals</operation>
            <value>a0c8c00000JJz9W</value>
        </criteriaItems>
        <criteriaItems>
            <field>copado__Deployment__c.copado__Source_Environment__c</field>
            <operation>equals</operation>
            <value>a0c8c00000JJz9WAAT</value>
        </criteriaItems>
